...
Data includes anonymized lifestyle, dietary, and physical attributes
...
## Results
Logistic Regression Test Accuracy: ~91%
Random Forest Test Accuracy: ~94%
Random Forest outperforms Logistic Regression across most obesity classes
Most misclassifications occur between adjacent obesity levels
